...
namespace BitaryProject.Extensions
{
    public static class InfraStructureServicesExtensions
    {
        ...
        public static IServiceCollection ConfigureIdentityService(this IServiceCollection services)
        {
            ...
            // Fix: Prevent Identity cookie from redirecting API calls to /Account/Login (404)
            // Instead, return proper 401/403 status codes for unauthorized/forbidden requests
